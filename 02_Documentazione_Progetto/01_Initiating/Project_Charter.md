...
Il progetto dovrà:
realizzare una piattaforma web accessibile da browser;
permettere la visualizzazione dei sentieri su una mappa interattiva;
mostrare informazioni come difficoltà, lunghezza, durata e stato del percorso;
integrare dati meteorologici aggiornati;
permettere agli utenti di registrarsi e salvare i percorsi preferiti;
consentire l’invio di segnalazioni relative a ostacoli o situazioni di pericolo;
fornire agli amministratori strumenti per gestire sentieri, segnalazioni e avvisi;
completare e validare una versione MVP entro i tempi e il budget stabiliti.
---
...
modulo meteo e stato dei percorsi;
sistema di segnalazione;
area amministrativa;
piano e risultati dei test;
